...
with(plot3data, {plot(Sub_metering_1~DateTime, type="l", ylab="Global Active Power (kilowatts)", xlab="") lines(Sub_metering_2~plot3data$DateTime,col='Red')
lines(Sub_metering_3~plot3$datetime,col='Blue')})
